...
import { ProductionPlanningItem } from '../production-dp/ProductionPlanningItem'
import { MonthPaging } from '../production-dp/MonthPaging'
...
export const Delivery = ({ status }: IDeliveryProps) => {
  ...
  const onSuccessAddition = () => {
    ...
    localStorage.setItem('_simulated_status', DeliveryPlanStatus.DELIVERY_APPROVED)
    navigate(0)
  }
