...
import MailLog from 'src/@example/views/___examples/apps/email/MailLog'
import SidebarLeft from 'src/@example/views/___examples/apps/email/SidebarLeft'
import ComposePopup from 'src/@example/views/___examples/apps/email/ComposePopup'
...
import {
  ...
  handleSelectMail,
  handleSelectAllMail
} from 'src/@example/store/___examples/apps/email'
