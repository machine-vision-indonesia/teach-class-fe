...
export const AccordionCustom = styled(MuiAccordion)<AccordionProps & { bgColor?: string }>(({ theme, bgColor }) => ({
  margin: 0,
...
export const AccordionSummaryCustom = styled(AccordionSummary)<AccordionSummaryProps & { bgColor?: string }>(
  ({ theme, bgColor }) => ({
    marginBottom: -1,
