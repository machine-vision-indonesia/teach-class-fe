      ...
      <main>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <div style={{ flexGrow: 1 }}>
            <Typography variant='h2'>Manage Area</Typography>
            <Breadcrumbs
          ...
          >
            <MenuItem
              ...
              href='/areas/add'
            >
              <span style={{ fontWeight: 500, fontSize: '14px', letterSpacing: '0.43px' }}>Data Area</span>
            ...
            <MenuItem
              ...
              href='/areas/add/bulk'
            >
              <span style={{ fontWeight: 500, fontSize: '14px', letterSpacing: '0.43px' }}>Bulk Data Area</span>
              ...
              <TableBody>
                {areas.map(area => (
                  <TableRow key={area.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                    <TableCell style={{ color: theme.palette.text.primary }}>{area.code}</TableCell>
                    <TableCell style={{ color: theme.palette.text.primary }}>{area.name}</TableCell>
                    <TableCell style={{ color: theme.palette.text.primary }}>{area.plant}</TableCell>
                    ...
                    <TableCell style={{ color: theme.palette.text.primary }}>
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            const qrValue = await QRCode.toDataURL(`${env('NEXT_PUBLIC_BASE_URL')}/areas/${area.id}`, {
                              width: 256
                            })
                            setQr(qrValue)
                            setQrModalOpen(true)
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            >
              <Button
                ...
                onClick={() => setDeleteModalOpen(false)}
              />
              <Button content='textOnly' text='Yes, delete it' variant='contained' color='error' size='medium' />
            </DialogActions>
          </div>
        </DialogContent>
      </Dialog>
