...
import PreviewDocumentFile from '@/modules/dms/clusters/inventory-transfer/pages/delivery/components/PreviewDocumentFile'
...
export const Step5 = () => {
  ...
  const onSubmitStep5 = () => {
    ...
    localStorage.setItem(
      ...
      InventoryTransferRequestStatus.DELIVERED
    )
    navigate(0)
  }
      ...
      <Stack width={'100%'} alignItems={'start'} rowGap={'12px'}>
        ...
        <SectionGroup color='default' title='Upload Document'>
          <Box display='flex' gap='16px'>
            <PreviewDocumentFile name='Dokumen 1' extension='pdf' size={100000} />
            <PreviewDocumentFile name='Dokumen 2' extension='pdf' size={100000} />
            <PreviewDocumentFile name='Dokumen 3' extension='pdf' size={100000} />
          </Box>
        </SectionGroup>
