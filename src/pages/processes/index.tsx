      ...
      <main>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <div style={{ flexGrow: 1 }}>
            <Typography variant='h2'>Manage Process</Typography>
            <Breadcrumbs
          ...
          >
            <MenuItem
              ...
              href='/processes/add'
            >
              <span style={{ fontWeight: 500, fontSize: '14px', letterSpacing: '0.43px' }}>Data Process</span>
              <Icon fontSize='16px' icon='material-symbols:add' />
            </MenuItem>
            <MenuItem
              style={{ padding: '8px 16px', margin: 0, justifyContent: 'space-between' }}
              component={NextLink}
              href='/processes/add/bulk'
            >
              <span style={{ fontWeight: 500, fontSize: '14px', letterSpacing: '0.43px' }}>Bulk Data Process</span>
            ...
            <Table sx={{ minWidth: 650 }}>
              <TableHead sx={{ backgroundColor: '#F5F8FF' }}>
                <TableRow>
                  ...
                  <TableCell style={{ color: theme.palette.text.secondary }}>Line</TableCell>
              ...
              <TableBody>
                {processes.map(prcs => (
                  <TableRow key={prcs.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                    <TableCell style={{ color: theme.palette.text.primary }}>{prcs.code}</TableCell>
                    <TableCell style={{ color: theme.palette.text.primary }}>{prcs.name}</TableCell>
                    <TableCell style={{ color: theme.palette.text.primary }}>{prcs.line}</TableCell>
                    <TableCell style={{ color: theme.palette.text.primary }}>{prcs.sector}</TableCell>
                    <TableCell style={{ color: theme.palette.text.primary }}>{prcs.plant}</TableCell>
                    ...
                    <TableCell style={{ color: theme.palette.text.primary }}>
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            const qrValue = await QRCode.toDataURL(
                              `${env('NEXT_PUBLIC_BASE_URL')}/processes/${prcs.id}`,
                              {
                                width: 256
                              }
                            )
