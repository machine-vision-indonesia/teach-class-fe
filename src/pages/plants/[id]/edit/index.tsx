        ...
        >
          <CardContent style={{ display: 'flex', flexDirection: 'column', rowGap: '20px', padding: 0 }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', rowGap: '5px', flexGrow: 1 }}>
              ...
              <Button
                ...
                endIcon={<Icon icon='mdi:pencil-outline' />}
                style={{ flexShrink: 0 }}
                type='button'
              />
            </div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', rowGap: '12px' }}>
                <div style={{ flexBasis: '100%', display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Button
                    ...
                    style={{ flexShrink: 0 }}
                    type='button'
                    href={`/plants/${router.query.id}/edit/plant-detail`}
                  />
                </div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', rowGap: '12px' }}>
                <div style={{ flexBasis: '100%', display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <Button
                    ...
                    style={{ flexShrink: 0 }}
                    type='button'
                    href={`/plants/${router.query.id}/edit/contact-and-location`}
                  />
                </div>
