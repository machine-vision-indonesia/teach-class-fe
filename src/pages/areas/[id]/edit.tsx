...
export default function ManagePlantsEditPage() {
    ...
    <main>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <div style={{ flexGrow: 1 }}>
          <Typography variant='h2'>Edit Area</Typography>
          <Breadcrumbs
          ...
          >
            ...
            <Link component={NextLink} href='/areas'>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            >
              <div style={{ gridColumn: 'span 2' }}>
                ...
                >
                  Complete the data to edit an Area
                </Typography>
              </div>
              ...
              <div>
                ...
                <Controller
                  ...
                  name='parent'
                  render={({ field: { value, onChange, ...rest }, fieldState }) => (
                    <Autocomplete<(typeof areaOptions)[number]>
                      options={areaOptions}
                      size='small'
                      id='parent'
                      sx={{
              ...
              <div>
                ...
                >
                  Area Code <span style={{ color: theme.palette.error.main }}>*</span>
                </label>
                <Controller
                  control={form.control}
                  name='code'
              ...
              <div>
                ...
                >
                  Area Name <span style={{ color: theme.palette.error.main }}>*</span>
                </label>
                <Controller
                  control={form.control}
                  name='name'
