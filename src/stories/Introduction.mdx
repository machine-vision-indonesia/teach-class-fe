...
# Welcome to Machine Vision's Design System

<div className="subheading">Getting Started</div>

👋 Hello there! You've arrived at Machine Vision’s Design System guidebook. Here, you will find a detailed account of our
UI system, including interactive examples and recommended use cases. We want to have appropriate and consistent use of our
components, so that's why this guidebook exists!
...
* WIDGETS : layouts and other UI groups that are composed of multiple components
* CHARTS : unique chart with specific use cases
...
* Ping Nendy Annisa, Dea Putri or someone in the Design team if you're not sure about anything related to UI systems
