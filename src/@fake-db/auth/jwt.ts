...
const users: UserDataType[] = [
  ...
  },
  {
    ...
    fullName: 'Jane Doe',
    username: 'janedoe',
    email: 'client@machinevision.com'
  }
]
...
const jwtConfig = {
  ...
  expirationTime: env('NEXT_PUBLIC_JWT_EXPIRATION'),
  refreshTokenSecret: env('NEXT_PUBLIC_JWT_REFRESH_TOKEN_SECRET')
}
  ...
  jwt.verify(token, jwtConfig.secret as string, (err, decoded) => {
    ...
    if (err) {
      ...
      if (defaultAuthConfig.onTokenExpiration === 'logout') {
        ...
        window.localStorage.setItem(defaultAuthConfig.accessTokenKeyName, accessToken)
