...
import UserViewBilling from 'src/@example/views/___examples/apps/user/view/UserViewBilling'
import UserViewAccount from 'src/@example/views/___examples/apps/user/view/UserViewAccount'
import UserViewSecurity from 'src/@example/views/___examples/apps/user/view/UserViewSecurity'
import UserViewConnection from 'src/@example/views/___examples/apps/user/view/UserViewConnection'
import UserViewNotification from 'src/@example/views/___examples/apps/user/view/UserViewNotification'
